...
pub async fn patch_ui_settings(
    ...
    app_settings::save_ui(&state.data.sqlx_pool(), &settings).await?;
...
pub async fn patch_converter_settings(
    ...
    app_settings::save_converter(&state.data.sqlx_pool(), &settings).await?;
...
pub async fn patch_library_scan_settings(
    ...
    app_settings::save_library_scan(&state.data.sqlx_pool(), &settings, state.config.debug).await?;
...
pub async fn patch_downloads_settings(
    ...
    app_settings::save_downloads(&state.data.sqlx_pool(), &settings).await?;
...
pub async fn patch_storage_settings(
    ...
    app_settings::save_storage(&state.data.sqlx_pool(), &settings).await?;
